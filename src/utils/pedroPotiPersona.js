...
export const pedroPotiPersona = {
	...
	showcaseFields: [
		...
		{
			fieldKey: 'showcase_council_channel',
			label: 'Council channel',
			type: 'select',
			options: ['Council messenger', 'Harbor liaison', 'Village assembly'],
			adminOnly: false,
			userEditable: true,
			userVisible: true,
			initialVisibility: 'users',
			sortOrder: 55,
			adminValue: { value: 'Council messenger', currentVisibility: 'users' },
			demoValue: { value: 'Village assembly', currentVisibility: 'users' },
		},
		{
